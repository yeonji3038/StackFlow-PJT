package ssafy.StackFlow.net.crizin;
...
public class KoreanRomanizerTest {
	...
	public void testName() {
		assertEquals("Gim Suhyeon", KoreanRomanizer.romanize("김수현", KoreanCharacter.Type.Name));
		assertEquals("Kim Suhyeon", KoreanRomanizer.romanize("김수현", KoreanCharacter.Type.NameTypical));
		assertEquals("I Sedol", KoreanRomanizer.romanize("이세돌", KoreanCharacter.Type.Name));
		assertEquals("Lee Sedol", KoreanRomanizer.romanize("이세돌", KoreanCharacter.Type.NameTypical));
		assertEquals("Bak Bogeom", KoreanRomanizer.romanize("박보검", KoreanCharacter.Type.Name));
		assertEquals("Park Bogeom", KoreanRomanizer.romanize("박보검", KoreanCharacter.Type.NameTypical));
		assertEquals("Choe Siwon", KoreanRomanizer.romanize("최시원", KoreanCharacter.Type.Name));
		assertEquals("Choi Siwon", KoreanRomanizer.romanize("최시원", KoreanCharacter.Type.NameTypical));
		assertEquals("Seonu Eunsuk", KoreanRomanizer.romanize("선우은숙", KoreanCharacter.Type.Name));
		assertEquals("Sunwoo Eunsuk", KoreanRomanizer.romanize("선우은숙", KoreanCharacter.Type.NameTypical));
	}
