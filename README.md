  ...
  <tbody>
    <tr>
     ...
     <tr/>
      ...
      <td align="center"><a href=""><img src="/src/hs.png" width="100px;" alt=""/><br /><sub><b>FE 팀원 : 서현석</b></sub></a><br /></td>
    </tr>
  </tbody>
</table>
...
| 날짜                | 일정 내용            | 체크  |
|---------------------|----------------------|-------|
| 2024-12-02 ~ 2025-01 | 개발 회의            | <input type="checkbox" checked disabled> |
| 2025-01-08          | 코드 리뷰            | <input type="checkbox" disabled> |
| 2025-01-09          | 배포 작업            | <input type="checkbox" disabled> |
| 2025-01-10          | 테스트 진행          | <input type="checkbox" disabled> |
| 2025-01-11          | 최종 점검 및 배포    | <input type="checkbox" disabled> |
