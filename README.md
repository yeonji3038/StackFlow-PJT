...
#### 서비스명 : StackFlow ( 재고관리 사이트 )

#### 한줄 설명 : `본사와 매장이 함께 쓰는 통합 재고관리 시스템`

#### 프로젝트 기간 : 2025.01.05 ~ 2025.06.30


## ✨ 프로젝트 소개

📦 StackFlow
입출고 이력 관리, 매장 간 재고이동, 공지사항 & 실시간 채팅까지
복잡한 엑셀 정리는 이제 그만!
StackFlow는 본사와 다지점 재고를 효과적으로 통합 관리할 수 있는 올인원 재고관리 서비스입니다.

🌟 StackFlow만의 특별함
🔄 매장 간 실시간 재고이동 (RT)
재고 이동 내역을 기록하고 승인/반려 기능까지 포함해, 투명한 이력 관리와 권한 제어를 동시에 지원합니다.

📥 입출고 요청 및 처리
각 매장의 입고/출고 현황을 실시간으로 확인하고, 재고 요청 및 이동을 자동 반영하여 오류 없는 재고 흐름을 보장합니다.

🏪 매장 코드 기반 인증
회원가입 시 매장 코드를 입력해 소속 매장 인증, 매장 단위 사용자 권한 관리 및 데이터 분리 운영이 가능합니다.

📦 상품 등록 및 조회 기능
상품 정보를 등록하고, 검색/필터 기능을 통해 원하는 제품을 신속하게 찾을 수 있습니다.

📢 공지사항 기능
본사에서 각 매장으로 공지사항을 일괄 전송할 수 있는 기능을 제공합니다.

💬 실시간 채팅 기능
본사 ↔ 매장, 매장 ↔ 매장 간의 실시간 커뮤니케이션을 지원하여,
입출고 요청, 재고 협의, 긴급 문의 사항 등을 신속하게 처리할 수 있습니다.
